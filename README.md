# [Flask and SocketIO](https://docs.appseed.us/technologies/flask/socketio/) `Coding Sample`

An open-source sample that explains how to use [Flask and SocketIO](https://docs.appseed.us/technologies/flask/socketio/), using `Gradient Able` design for styling. 

- 👉 Free [Support](https://appseed.us/support/) via `Email` & `Discord`
- 👉 [Custom Development Services](https://appseed.us/custom-development/) for NodeJs, Python, APIs, and Frontend (React, Vue, VanillaJS) 
...
---
[Flask and SocketIO](https://docs.appseed.us/technologies/flask/socketio/) `Coding Sample` provided by **[AppSeed](https://appseed.us/)**.
